...
<p class=p>Команда <b>Remove</b> удаляет авторизацию у выбранного контакта, после этого он не сможет видеть вас в сети. Запрос авторизации приходит в виде сообщения и помещается в чат. Авторизовать пользователя, просящего об этом, можно прямо из окна просмотра этого запроса дополнительной командой <b>Authorize</b>. Контакты с авторизацией <i>none</i> отображаются значками со знаком вопроса, а контакты с <i>from, ask</i> - значками с двумя стрелками.</p>
